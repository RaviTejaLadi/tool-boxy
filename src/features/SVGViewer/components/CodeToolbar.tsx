...
import { getSvgDimensions } from '../helpers';
...
export function CodeToolbar() {
  ...
  return (
    <div className="flex shrink-0 flex-wrap items-center gap-1.5 border-b border-border px-3 py-2">
      ...
      <span className="mx-1 font-mono text-[11px] text-muted-foreground">
        ...
        <Popover>
          ...
          <PopoverContent align="end" className="w-56">
            <div className="flex items-center justify-between gap-3">
              <Label htmlFor="svg-word-wrap" className="font-mono text-[11px]">
                Word wrap
              </Label>
              <Switch id="svg-word-wrap" checked={wordWrap} onCheckedChange={setWordWrap} />
            </div>
          </PopoverContent>
        </Popover>
      </div>
