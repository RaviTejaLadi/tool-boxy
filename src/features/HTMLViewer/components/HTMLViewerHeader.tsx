...
export function HTMLViewerHeader() {
  ...
  return (
    <header className="flex shrink-0 items-center justify-between border-b border-border px-6 py-3">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <div className="font-heading text-sm leading-none font-semibold">HTML Viewer</div>
          <div className="mt-1 font-mono text-[11px] leading-none text-muted-foreground">
            Live HTML preview with Tailwind and CSS support
          </div>
        </div>
      </div>
